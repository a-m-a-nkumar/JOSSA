        ...
        <footer className="bg-gray-800 py-10">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center text-white">
                ...
                <div className="flex flex-col items-center space-y-2 mb-4">
                    <span>Developed with ❤️ by Aman.</span>
                    <div className="flex space-x-4">
                        <a href="https://www.linkedin.com/in/aman-kumar620/" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-blue-500 transition duration-300 ease-in-out">
                        ...
                        <a href="https://github.com/a-m-a-nkumar/JOSSA" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-blue-500 transition duration-300 ease-in-out">
